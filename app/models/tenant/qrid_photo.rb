class Tenant::QridPhoto < ActiveRecord::Base
  belongs_to :qrid

  has_attached_file :photo,
                    path: ':database/qrids/:id_partition/:hash/:style.:extension',
  ...
  def self.transfer_and_cleanup(id)
    ...
    photo = Tenant::QridPhoto.find(id)
  ...
  protected
    ...
    def queue_processing
      Tenant::QridPhoto.delay.transfer_and_cleanup(id)
    end
